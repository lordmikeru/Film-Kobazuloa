...
if(isset($_POST['email']))
{
    ...
    if (!isset($_POST['name']) ||
        ...
        !isset($_POST['message']))
    {
        return_error('Mesedez, eremu guztiak bete!');
    }
    ...
    // name
    $name_exp = "/^[a-z0-9 .\-]+$/i";
    if (!preg_match($name_exp,$name)) // balio ez duten karaktereak baditu
    {
    ...
    if (!preg_match($email_exp,$email)) // balio ez duten karaktereak baditu
    {
...
{
    echo 'Mesedez, eremu guztiak bete!';
    die();
}
?>
