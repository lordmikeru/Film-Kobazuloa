        ...
        <div class="container">
            <div class="row">
              ...
              <script>
                  ...
                  function irten()
                  {
                      window.location = "php/sesioa_itxi.php";
                  }
              </script>
              <!-- ./hasieratu -->
              ...
              <?php 
                  if (!isset($_SESSION["logged_user"]))
                  { // LOGEATU GABE
                      printf('<div class="formularioa">
                                <h1><u>LOGIN</u></h1> <br/>
                                <table>
                                    <form action="php/login_kontsultatu.php" method="POST">
                                        <tr>
                  ...
                  { // LOGEATUTA
                      echo "Ongi etorri Film Kobazulora <b>", $_SESSION['logged_user'], "</b>!<br/>";
                      printf('<div class="formularioa">
                                <input type="submit" value="IRTEN" onclick="irten()"></td>
                              </div>');
                  }
              ?>
